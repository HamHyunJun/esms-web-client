...
export default {
    ...
    async getAsRequestList(){
      ...
      if(this.selectedSidoItems != '' && this.selectedSggItems == ''){
        ...
        //const url  = this.$store.state.serverApi + `/admin/as/list.do?asStateCd=STE001&pageIndex=0&recordCountPerPage=1000`
        const url = this.$store.state.serverApi
        +"/admin/as/list.do?pageIndex=1&recordCountPerPage=1000"
